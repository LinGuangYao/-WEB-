...
function SDTJ(ee) {
    ...
    xxhtml += "<div class='form-group'><h4>位置录入:</h4> </div> <br>";

    xxhtml += " <table class='gridtable' style='width:95%;margin:0px auto;'>" + " <tr>"
           + "<th scope='col'>街道位置:</th>" + "<td><input type='text' class='form-control' size='60' id='JieDaoXingXi' '/></td>"
           + "</table>"

    xxhtml += "<div class='form-group'><h4>信息录入:</h4> </div> <br>";
    xxhtml+=" <table class='gridtable' style='width:95%;margin:0px auto;'>"+" <tr>"
//                                + "<th scope='col'>街道位置:</th>" + "<td><input type='text' class='form-control' size='50' id='JieDaoXingXi' '/></td>"
